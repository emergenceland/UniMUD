...
var ASM_CONSTS = {
  4997972: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4998027: function($0) {performance.now = function() { return $0; };},  
 4998075: function($0) {performance.now = function() { return $0; };},  
 4998123: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4998178: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4998239: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4998303: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _WebSocketConnect(instanceId) {
      ...
      instance.ws.onmessage = function (ev) {
        ...
        if (ev.data instanceof ArrayBuffer) {
          ...
          try {
            Module["dynCall_viii"](webSocketState.onMessage, [
              instanceId,
              buffer,
              dataBuffer.length,
            ]);
      ...
      instance.ws.onerror = function (ev) {
        ...
        if (webSocketState.onError) {
          ...
          try {
            Module["dynCall_vii"](webSocketState.onError, [
              instanceId,
              msgBuffer,
            ]);
          } finally {
...
/** @type {function(...*):?} */
var dynCall_iijjiiiiiiii = Module["dynCall_iijjiiiiiiii"] = createExportWrapper("dynCall_iijjiiiiiiii");
...
/** @type {function(...*):?} */
var dynCall_vijjjjjjii = Module["dynCall_vijjjjjjii"] = createExportWrapper("dynCall_vijjjjjjii");

/** @type {function(...*):?} */
var dynCall_vijjjjjjiji = Module["dynCall_vijjjjjjiji"] = createExportWrapper("dynCall_vijjjjjjiji");
