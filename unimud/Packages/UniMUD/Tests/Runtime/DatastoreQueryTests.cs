...
//
//             var set = new List<IRxRecord>();
//             var removed = new List<IRxRecord>();
...
//         
//         [Test]
//         public void RxQueryOrder()
//         {
//             var position = Common.CreateProperty(("x", 1), ("y", 2), ("timestamp", DateTime.UtcNow));
//             var position2 = Common.CreateProperty(("x", 1), ("y", 1), ("timestamp", DateTime.UtcNow)));
//             var h1 = Common.CreateProperty(("value", 100), ("timestamp", DateTime.UtcNow));
//             var h2 = Common.CreateProperty(("value", 50), ("timestamp", DateTime.UtcNow));
//
//             _ds.Set(_components["Position"], "a", position);
//             _ds.Set(_components["Position"], "b", position);
//             _ds.Set(_components["Health"], "a", h1); // A has full health, we should only get updates for A
...
//             _ds.Update(_components["Position"], "b", position2);
//             // change position of entity A back to original
//             _ds.Update(_components["Position"], "a", position); 
//
//             // make sure we only have 3 updates
//             Assert.AreEqual(3, set.Count);
//
