...
//             Assert.AreEqual(2,
//                 _ds.store[_components["Position"].Id].Entries.Count); // should have 2 records in Position table
//
//             Assert.AreEqual(100, _ds.GetValue(_components["Health"], "a")?.RawValue["value"]); // should have 100 health 
//         }
//
//         [Test]
...
//             Assert.AreEqual(1, _ds.store[_components["Position"].Id].Entries.Count);
//             Assert.AreEqual(1, _ds.GetValue(_components["Position"], "a")?.RawValue["x"]);
//             Assert.AreEqual(2, _ds.GetValue(_components["Position"], "a")?.RawValue["y"]);
//
//             // update the value
...
//
//             // use GetValue
//             Assert.AreEqual(3, _ds.GetValue(_components["Position"], "a")?.RawValue["x"]);
//             Assert.AreEqual(4, _ds.GetValue(_components["Position"], "a")?.RawValue["y"]);
//         }
//
//         [Test]
