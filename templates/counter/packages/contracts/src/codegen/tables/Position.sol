...
library Position {
   ...
   * @notice Get layer.
   */
  function getLayer(bytes32 key) internal view returns (int32 layer) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get layer.
   */
  function _getLayer(bytes32 key) internal view returns (int32 layer) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /**
   * @notice Get layer (using the specified store).
   */
  function getLayer(IStore _store, bytes32 key) internal view returns (int32 layer) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Set layer.
   */
  function setLayer(bytes32 key, int32 layer) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((layer)), _fieldLayout);
  }

  /**
   * @notice Set layer.
   */
  function _setLayer(bytes32 key, int32 layer) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreCore.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((layer)), _fieldLayout);
  }

  /**
   * @notice Set layer (using the specified store).
   */
  function setLayer(IStore _store, bytes32 key, int32 layer) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    _store.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((layer)), _fieldLayout);
  }
   ...
   */
  function set(bytes32 key, int32 x, int32 y, int32 layer) internal {
    bytes memory _staticData = encodeStatic(x, y, layer);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32 key, int32 x, int32 y, int32 layer) internal {
    bytes memory _staticData = encodeStatic(x, y, layer);
   ...
   */
  function set(IStore _store, bytes32 key, int32 x, int32 y, int32 layer) internal {
    bytes memory _staticData = encodeStatic(x, y, layer);
  ...
  function set(bytes32 key, PositionData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.x, _table.y, _table.layer);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (int32 x, int32 y, int32 layer) {
    x = (int32(uint32(Bytes.slice4(_blob, 0))));

    y = (int32(uint32(Bytes.slice4(_blob, 4))));

    layer = (int32(uint32(Bytes.slice4(_blob, 8))));
  }
  ...
  function decode(
    ...
    (_table.x, _table.y, _table.layer) = decodeStatic(_staticData);
  }
   ...
   */
  function encodeStatic(int32 x, int32 y, int32 layer) internal pure returns (bytes memory) {
    return abi.encodePacked(x, y, layer);
  }
   ...
   */
  function encode(int32 x, int32 y, int32 layer) internal pure returns (bytes memory, PackedCounter, bytes memory) {
    bytes memory _staticData = encodeStatic(x, y, layer);
