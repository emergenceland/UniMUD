...
library Position {
  ...
  /**
   * @notice Get hasWaited.
   */
  function getHasWaited(bytes32 key) internal view returns (bool hasWaited) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * @notice Get hasWaited.
   */
  function _getHasWaited(bytes32 key) internal view returns (bool hasWaited) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /**
   * @notice Get hasWaited (using the specified store).
   */
  function getHasWaited(IStore _store, bytes32 key) internal view returns (bool hasWaited) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /**
   * @notice Set hasWaited.
   */
  function setHasWaited(bytes32 key, bool hasWaited) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((hasWaited)), _fieldLayout);
  }

  /**
   * @notice Set hasWaited.
   */
  function _setHasWaited(bytes32 key, bool hasWaited) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreCore.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((hasWaited)), _fieldLayout);
  }

  /**
   * @notice Set hasWaited (using the specified store).
   */
  function setHasWaited(IStore _store, bytes32 key, bool hasWaited) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    _store.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((hasWaited)), _fieldLayout);
  }
   ...
   */
  function set(bytes32 key, int32 x, int32 y, bool hasWaited) internal {
    bytes memory _staticData = encodeStatic(x, y, hasWaited);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32 key, int32 x, int32 y, bool hasWaited) internal {
    bytes memory _staticData = encodeStatic(x, y, hasWaited);
   ...
   */
  function set(IStore _store, bytes32 key, int32 x, int32 y, bool hasWaited) internal {
    bytes memory _staticData = encodeStatic(x, y, hasWaited);
  ...
  function set(bytes32 key, PositionData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.x, _table.y, _table.hasWaited);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (int32 x, int32 y, bool hasWaited) {
    x = (int32(uint32(Bytes.slice4(_blob, 0))));

    y = (int32(uint32(Bytes.slice4(_blob, 4))));

    hasWaited = (_toBool(uint8(Bytes.slice1(_blob, 8))));
  }
  ...
  function decode(
    ...
    (_table.x, _table.y, _table.hasWaited) = decodeStatic(_staticData);
  }
   ...
   */
  function encodeStatic(int32 x, int32 y, bool hasWaited) internal pure returns (bytes memory) {
    return abi.encodePacked(x, y, hasWaited);
  }
   ...
   */
  function encode(int32 x, int32 y, bool hasWaited) internal pure returns (bytes memory, PackedCounter, bytes memory) {
    bytes memory _staticData = encodeStatic(x, y, hasWaited);
